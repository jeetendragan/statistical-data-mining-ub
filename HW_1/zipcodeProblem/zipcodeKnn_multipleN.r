# the script takes one command line argument, the value of n. 
...
x11();
qplot(x = kValues, y = accuracyVectorTestData, xlab="K Values", ylab="Accu");
x11()
qplot(x = kValues, y = accuracyVectorTrainingData, xlab="K values", ylab="Acc-Training")
